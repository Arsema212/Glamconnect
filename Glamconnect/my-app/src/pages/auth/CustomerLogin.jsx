...
const CustomerLogin = () => {
  ...
  const handleContinue = (e) => {
    e.preventDefault();
    // Mock login
    login({ name: 'Arsema Mengistu', email, role: 'customer' });
    navigate('/');
  };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center px-8 py-12 relative">
        ...
        <div className="max-w-md mx-auto w-full">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">For Customers</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">Have a business account?</p>
            <Link to="/login/professional" className="text-blue-600 hover:underline">
